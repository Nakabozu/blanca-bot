/* BLANCA HOOK!
           ...
           allItems.forEach(item => {
               if(shouldAddItem(item["rarity"])){
                   ...
                   if(item["rarity"] <= 1){
                       ...
                       if(item["item"]["entries"] && Array.from(item["item"]["entries"]).every(entry => typeof entry === "string")){
   ...
   const getFluffImageLink = (itemSource, itemName) => {
